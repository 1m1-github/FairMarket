...
goal app call --from $A --app-id $FAIRMARKET_APP --foreign-asset $CURRENCY_ID --app-arg "str:create_bid" --app-arg "addr:$B" --app-arg "b64:$BID_ID_B64" --box "addr:$B" --box "b64:$BID_ID_B64" --out $TXNS_DIR/app_call.txn --fee 5000
